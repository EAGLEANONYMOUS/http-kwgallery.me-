    ...
    <head>
        <title>CSRF Online</title>
         ...
         <script src="https://cdn.rawgit.com/bungfrangki/efeksalju/2a7805c7/efek-salju.js" type="text/javascript"></script>
          <link rel="icon" type="image/png" href="https://i.ibb.co/WzWnxGz/Screenshot-20200719-131421-Gallery.jpg">
             <br>
                <br>
                   <br>
                      <body style="background-color: rgb(0, 0, 0); color: rgb(0, 0, 0);"alink="#ee0000" link="#0000ee" vlink="#551a8b">
                         <span style="color: rgb(242, 239, 239);">
                            <br>
                               ...
                               <center> 
                               <div class="error">
                                  <img border="0" src="https://i.ibb.co/WzWnxGz/Screenshot-20200719-131421-Gallery.jpg" width="250" height="">
                                     <br>
                                      ...
                                      <br>                                                                         </br>
                                           ...
                                           <font size="4" face="Ubuntu Mono">rizky07 Gant3ng</font></p>
                                           <br>
                                <div style="display">		
                                               <center>
<form method="post">
